...
function _TechStack({ projectN: e }) {
  ...
  return T.jsxs("div", {
    ...
    children: [
      T.jsx("div", {
        style: { fontSize: "clamp(0.55rem,0.8vw,0.75rem)", color: "rgba(215,226,234,0.4)", textTransform: "uppercase", letterSpacing: "0.15em", fontWeight: 600, marginBottom: 4 },
        children: "Tech Stack",
      }),
      t.map((r, i) =>
        T.jsxs("div", {
          ...
          children: [
            T.jsx("span", { style: { fontSize: 16 }, children: r.icon }),
            T.jsx("span", { style: { fontSize: "clamp(0.65rem,1vw,0.85rem)", color: "#D7E2EA", fontWeight: 500 }, children: r.name }),
          ],
        }, i)
      ),
    ],
...
function C2({ p: e, idx: t, total: n, live: r }) {
  ...
  return T.jsx("div", {
    ref: i,
    style: {
      minHeight: "fit-content", position: "sticky", top: 0, display: "flex", alignItems: "flex-start", justifyContent: "center", paddingTop: `${50 + t * 16}px`, paddingBottom: "120px",
    },
...
function E2({ s: e, delay: t }) {
  const [n, r] = L.useState(!1);
  return T.jsx(Re, {
    delay: t,
    y: 40,
    children: T.jsxs(tt.a, {
      href: e.href,
      target: "_blank",
      rel: "noopener noreferrer",
      onHoverStart: () => r(!0),
      onHoverEnd: () => r(!1),
      animate: n ? { y: -10, scale: 1.07 } : { y: 0, scale: 1 },
        ...
        children: [
          T.jsx(Re, {
            ...
            children: T.jsxs("nav", {
              style: {
                display: "flex",
                justifyContent: "center", width: "100%", alignItems: "center", padding: "28px 40px 0", gap: "clamp(20px,4vw,60px)",
                position: "relative",
              },
              children: [
                n.nav.map((u, c) =>
            ...
            T.jsx(
              "div",
              {
                style: {
                  display: "flex",
                  gap: 12,
                  transform: `translateX(${c === 0 ? i - 200 : -(i - 200)}px)`,
                  willChange: "transform",
                },
                children: u.map((f, d) =>
                  T.jsxs(
          ...
          [
            {
              ...
              delay: 0.1,
              x: -120,
              style: { top: "4%", left: "2%", width: "clamp(80px,11vw,170px)" },
            },
            {
